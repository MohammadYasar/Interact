...
class INTERACTDataset(data.Dataset):
    ...
    def _load_summary(self, split_name):
        _summary_file = "./data/{}_{}v1.csv".format(self.exp_type, split_name)
        print ("summary_file ", _summary_file)
        import pandas as pd
    ...
    def _load_all(self):
        ...
        print (np.std(npall_interact_motion_poses[:,:3], keepdims=True))
        print (np.mean(npall_interact_motion_poses[:,:3], keepdims=True))
    ...
    def __getitem__(self, index):
        ...
        return interact_motion_input, interact_motion_target, video_motion_view1, video_motion_view2
